...
function AchievementCard({ achievement, index }: { achievement: Achievement; index: number }) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'relative overflow-hidden rounded-2xl bg-white p-5 shadow-sm transition-all duration-200',
    ...
    >
      ...
      <div className={cn(
        ...
        achievement.isUnlocked ? style.bg : 'bg-gray-100'
      )}>
        <Icon className={cn(
          'h-6 w-6',
  ...
  return (
    <div>
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">Achievements</h1>
      ...
      {!loading && data && (
        <motion.div
          ...
          className="mb-6 flex items-center gap-3 rounded-2xl bg-white p-4 shadow-sm"
        >
      ...
      {loading ? (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="rounded-2xl bg-white p-5 shadow-sm">
              ...
              <div className="mt-1 h-3 w-36 animate-pulse rounded bg-gray-200" />
        ...
        <div className="flex flex-col items-center justify-center rounded-xl bg-white py-16 shadow-sm">
          ...
          <h3 className="text-lg font-semibold text-gray-900">No achievements available</h3>
